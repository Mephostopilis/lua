...
function cls:SortCards() 
    ...
    local playerGroup = self._context:get_group(Matcher({PlayerComponent}))
    playerGroup.entities:foreach(function (entity, ... )
        -- body
...
--         private Dictionary<long, GameEntity> _entities = new Dictionary<long, GameEntity>();
...
--                 return _entities[index] as GameEntity;
--             }
--             return null;
--         }
