...
function cls:OnEnter()
    if not self.go then
        ...
        self._Tips = transform:Find("Tips").gameObject
        self._Gold = transform:Find("Gold").gameObject
        self._Leave = transform:Find("Leave").gameObject
        self._Mark = transform:Find("Que").gameObject
        self._Say = transform:Find("Say").gameObject
        self._Head = transform:Find("Head").gameObject
        local optionsRectTransform = transform:Find("Options")
        self._Hu = optionsRectTransform:Find("HuView").gameObject
        self._Peng = optionsRectTransform:Find("PengView").gameObject
        self._Ready = optionsRectTransform:Find("Ready").gameObject
        self._WAL = optionsRectTransform:Find("WAL").gameObject
        self.crak = transform:Find("Crak").gameObject
        self.bam = transform:Find("Bam").gameObject
        self.dot = transform:Find("Dot").gameObject
    end
    ...
    local optionsRectTransform = rectTransform:Find("Options")
...
function cls:ShowWAL(orient, value)
    ...
    if not self._WAL.activeSelf then
