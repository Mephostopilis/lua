...
do
	...
	print(
		"lookto matrix:",
		math3d.tostring(mat2),
		"eyepos:",
		math3d.tostring(eyepos),
		"direction:",
...
do
	...
	local vp =
		math3d.mul(
		math3d.projmat {aspect = 60, fov = 1024 / 768, n = 0.1, f = 100},
		math3d.lookto(math3d.vector(0, 0, -10), math3d.vector(0, 0, 1))
	)
	...
	print(
		"frusutm aabb center:",
		math3d.tostring(f_aabb_center),
		"extents:",
		math3d.tostring(f_aabb_extents),
		"radius:",
		math3d.length(f_aabb_extents)
	)
